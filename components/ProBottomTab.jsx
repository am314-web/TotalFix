...
import { Bell, Briefcase, Home, MessageCircle, User } from "lucide-react-native";
...
const tabs = [
  { label: "Home", route: "/pro-dashboard", icon: Home },
  { label: "Jobs", route: "/pro-history", icon: Briefcase },
  { label: "Chat", route: "/pro-chat", icon: MessageCircle },
  { label: "Profile", route: "/pro-profile", icon: User },
];

export default function ProBottomTab() {
    ...
    <View style={s.tabWrapper}>
      ...
      >
        <LinearGradient colors={[P, P2]} style={s.tabCenterGrad}>
          <Bell color="white" size={26} strokeWidth={2.5} />
        </LinearGradient>
      </TouchableOpacity>
    </View>
  );
